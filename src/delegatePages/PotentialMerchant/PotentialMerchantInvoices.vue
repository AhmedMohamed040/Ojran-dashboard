              ...
              <div class="text-center">
                <v-menu offset-y>
                  ...
                  <v-list>
                    ...
                    <v-list-item v-show="item.orderStatus === 'Accepted' || item.orderStatus === 'Pending' || item.orderStatus === 'Prepared' || item.orderStatus === 'Delivered'">
                      <v-list-item-title>
                        <v-dialog
                          transition="dialog-top-transition"
                          max-width="1200"
                              ...
                              <v-card-text>
                                <v-form v-model="valid">
                                  <v-row class="my-2">
                                    ...
                                    <v-col cols="6">
                                      <v-text-field
                                        v-model="receiptVoucher.andThatIsInReturn"
                                        outlined
                                        rows="4"
                                        :rules="[rules.required]"
                                        :label="$t('Invoices.andThatIsInReturn')"
                                      ></v-text-field>
                                    </v-col>
                                    <v-col cols="6">
                                      <v-file-input
                              ...
                              <v-card-text>
                                <v-container>
                                  ...
                                  <v-row class="my-2">
                                    ...
                                    <v-col cols="9">
                                      <div>
                                        <span v-if="getInvoice.user.name" class="m-0">
                                    ...
                                    <v-col cols="9">
                                      <div>
                                        <span v-if="getInvoice.user.userName" class="m-0">
                                    ...
                                    <v-col cols="9">
                                      <div>
                                        <span v-if="getInvoice.user.email" class="m-0">
                                    ...
                                    <v-col cols="9">
                                      <div>
                                        <span v-if="getInvoice.user.phone" class="m-0">
                                    ...
                                    <v-col cols="9">
                                      <div>
                                        <span v-if="getInvoice.user.adress" class="m-0">
                                    ...
                                    <v-col cols="9">
                                      <div>
                                        <span v-if="getInvoice.user.number" class="m-0">
                                    ...
                                    <v-col cols="9">
                                      <div>
                                        <span v-if="getInvoice.user.companyName" class="m-0">
                                    ...
                                    <v-col cols="9">
                                      <div>
                                        <div>
                                          <span v-if="getInvoice.user.activity" class="m-0">
                                    ...
                                    <v-col cols="9">
                                      <div>
                                        <div>
                                          <span v-if="getInvoice.user.city.name" class="m-0">
                                    ...
                                    <v-col cols="9">
                                      <div>
                                        <div>
                                          <span
                                            v-if="
                                              String(getInvoice.user.priceCategory) &&
                                                getInvoice.user.priceCategory != null
                                            "
                                            class="m-0"
                                          >
                                            {{
                                              $i18n.locale == 'ar'
                                                ? getInvoice.user.priceCategory.nameAr
                                                : getInvoice.user.priceCategory.nameEn
                                            }}
                                          </span>
                                          <span v-else>{{ $t('common.doesnotExist') }}</span>
                                        </div>
                                  ...
                                  <v-row class="my-2">
                                    ...
                                    <v-col cols="9">
                                      <div>
                                        <span v-if="getInvoice.orderId" class="m-0">
                                          {{ getInvoice.orderId }}
                                        </span>
                                        <span v-else>{{ $t('common.doesnotExist') }}</span>
                                      </div>
                                    ...
                                    <v-col cols="9">
                                      <div>
                                        <div>
                                          <span
                                            v-if="String(getInvoice.customDiscount)"
                                            class="m-0"
                                          >
                                            {{ getInvoice.customDiscount.toFixed(2) }}
                                            {{ $t('common.sar') }}</span>
                                          <span v-else>{{ $t('common.doesnotExist') }}</span>
                                        </div>
                                      </div>
                                    ...
                                    <v-col cols="9">
                                      <div>
                                        <div v-if="getInvoice.customPrice">
                                          <span
                                            v-if="String(getInvoice.customPrice)"
                                            class="m-0"
                                          >
                                    ...
                                    <v-col cols="9">
                                      <div>
                                        <div v-if="getInvoice.orderStatus">
                                          <span
                                            v-if="getInvoice.orderStatus === 'Pending'"
                                            class="m-0 deep-orange--text text--darken-4"
                                          >
                                            {{ $t(`common.${getInvoice.orderStatus}`) }}</span>
                                          <span
                                            v-if="getInvoice.orderStatus === 'Accepted'"
                                            class="m-0 success--text text--darken-2"
                                          >
                                            {{ $t(`common.${getInvoice.orderStatus}`) }}</span>
                                          <span
                                            v-if="getInvoice.orderStatus === 'Prepared'"
                                            class="m-0 success--text text--darken-2"
                                          >
                                            {{ $t(`common.${getInvoice.orderStatus}`) }}</span>
                                          <span
                                            v-if="getInvoice.orderStatus === 'Delivered'"
                                            class="m-0 success--text text--darken-2"
                                          >
                                            {{ $t(`common.${getInvoice.orderStatus}`) }}</span>
                                          <span
                                            v-if="getInvoice.orderStatus === 'Rejected'"
                                            class="m-0 red--text"
                                          >
                                            {{ $t(`common.${getInvoice.orderStatus}`) }}</span>
                                          <span
                                            v-if="getInvoice.orderStatus === 'Canceled'"
                                            class="m-0 red--text"
                                          >
                                            {{ $t(`common.${getInvoice.orderStatus}`) }}</span>
                                        </div>
                                  ...
                                  <v-row class="my-2">
                                    ...
                                    <v-col cols="9">
                                      <div>
                                        <span v-if="getInvoice.fullyPaidDate" class="m-0">
                                          {{ getInvoice.fullyPaidDate.substr(0, 10) }}
                                        </span>
                                        <span v-else>{{ $t('common.doesnotExist') }}</span>
                                      </div>
                                    </v-col>
...
export default {
  ...
  methods: {
    ...
    searchFilters() {
      ...
      this.isLoading = true
      this.fetchInvoices(this.searchFilter).finally(() => {
    ...
    optionsClick(item, index = 0) {
      this.fetchInvoice(item.id).then(() => {
    ...
    createVoucher(id) {
      ...
      this.createReceiptVoucher(this.receiptVoucher).then(() => {
        this.fetchInvoices(this.searchFilter).then((res) => {
          console.log(res)
          if (res.status == 200) {
            this.isLoading = false
  ...
  watch: {
    $route: {
      async handler(route) {
        ...
        this.$store
          .dispatch('PotentialMerchant/fetchInvoices', this.searchFilter)
          .then(() => {
            this.loading = false
          })
      },
