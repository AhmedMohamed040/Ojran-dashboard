<template>
  <div class="d-flex flex-column flex-grow-1">
    <div class="d-flex align-center py-3">
      <div>
        <div class="display-1">{{ $t('geography.regions') }}</div>
          ...
          <div class="d-flex justify-space-between w" style="width: 100%;">
            <div class="d-flex align-center" >
              <v-text-field
                ...
                outlined
                hide-details
                @input="fetchRegions(searchFilter)"
              ></v-text-field>
              <v-btn
                color="primary"
                class="mx-2"
          ...
          <template v-slot:default="dialog">
            <v-card>
              <v-toolbar color="red" dark>{{
                $t('geography.deleteRegion')
              }}</v-toolbar>
              <v-card-text>
                <h4 class="my-3 red--text">
                  {{ $t('geography.AreYouSureYouWantToDeleteThisRegion') }}
                </h4>
              </v-card-text>
...
export default {
  ...
  data() {
    return {
      ...
      breadcrumbs: [
        {
          text: this.$i18n.t('geography.regions'),
          disabled: false,
          href: '#'
        },
        {
  ...
  computed: {
    ...mapGetters('GeographyCrud', ['getRegionsList']),
    formTitle() {
      return this.editedIndex === -1
        ? this.$i18n.t('geography.createRegion')
        : this.$i18n.t('geography.updateRegion')
    }
  },
